...
def write_partial_index(partial_index_count: int):
    with open(r"C:\Users\srb71\Documents\GitHub\CS-121-Assignment-3\indexes\index" + str(partial_index_count) + ".txt", "w", encoding="utf-8") as file:
...
def merge_index():
    ...
    for letter in LETTERS:
        ...
        with open(r"C:\Users\srb71\Documents\GitHub\CS-121-Assignment-3\indexes\index" + letter + ".txt", "w") as open_file:
            word_line = 1
